...
/// (Vector2 and Vector3).
///
/// To keep things simple, fe::Rect doesn't define
...
///
/// This means that fe::IntRect(0, 0, 1, 1) and fe::IntRect(1, 1, 1, 1)
/// don't intersect.
///
/// fe::Rect is a template and may be used with any numeric type, but
/// for simplicity the instantiations used by SFML are typedef'd:
/// \li fe::Rect<int> is fe::IntRect
/// \li fe::Rect<float> is fe::FloatRect
///
