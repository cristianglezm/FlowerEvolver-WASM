...
namespace fe{
	...
	struct FE_API Image final{
		 ...
		 * @param pos const fe::Vector2f& position
		 * @param color const fe::Color& color
		 */
     ...
     */
    FE_API std::string encodeToBase64(const std::vector<std::uint8_t>& data);
    /**
     ...
     */
    FE_API std::vector<std::uint8_t> encodeImageToPngInMemory(const Image& image);
} // namespace fe
